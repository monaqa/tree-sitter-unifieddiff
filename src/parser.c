...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_git_index_added, 6),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hunk_length, 1),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hunk_range_old, 4),
  [203] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [205] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_to_file_line, 6),
  [209] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [211] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_hunk_range_new, 4),
};
